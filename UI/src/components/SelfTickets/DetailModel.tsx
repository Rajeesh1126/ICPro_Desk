        ...
        <DialogTitle component="div" sx={modalFormHeaderSx}>
          ...
          >
            ...
            <Box sx={selfTicketsDetailModelBoxSx1}>
              {task.reporting_to == currentUserId ? (
                <Stack
                  direction="row"
                  spacing={1}
                  alignItems="center"
                  ...
                  {task.logs?.map((log: any) => (
                    <Box
                      ...
                      sx={selfTicketsDetailModelCommentWrapperSx({
                        ...
                        isDark,
                        theme,
                        isCurrentUser: log.creator === currentUserId,
                      })}
                    >
                      <Typography
                        variant="caption"
            ...
            {/* {!!task.comments && (
              <Grid size={{ xs: 12, md: 12 }}>
                ...
                >
                  ...
                  <Typography
                    sx={selfTicketsDetailModelDynamicDynamicTypographySx7({
                      detailValueSx,
                    })}
                  >
                    {typeof task.comments === "string" ? task.comments : "N/A"}
                  </Typography>
                </Box>
              </Grid>
            )} */}
