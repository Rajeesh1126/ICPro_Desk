...
import {
  ...
  getStatusColor,
  marginTopSectionSx,
  ticketsDetailModalAvatarSx1,
  ticketsDetailModalAvatarSx2,
  ticketsDetailModalBoxSx1,
  ticketsDetailModalBoxSx2,
  ticketsDetailModalCallbackCallbackSx1,
  ticketsDetailModalCallbackCallbackSx3,
  ticketsDetailModalCallbackCallbackSx4,
  ticketsDetailModalChipSx1,
  ticketsDetailModalDynamicDynamicBoxSx1,
  ticketsDetailModalDynamicDynamicBoxSx2,
  ticketsDetailModalDynamicDynamicBoxSx3,
  ticketsDetailModalDynamicDynamicBoxSx6,
  ticketsDetailModalDynamicDynamicBoxSx7,
  ticketsDetailModalDynamicDynamicBoxSx8,
  ticketsDetailModalDynamicDynamicBoxSx9,
  ticketsDetailModalDynamicDynamicChipSx1,
  ticketsDetailModalDynamicDynamicChipSx2,
  ...
  ticketsDetailModalDynamicDynamicTypographySx3,
  ticketsDetailModalIconButtonSx1,
  ticketsDetailModalPaperSx1,
  ticketsDetailModalStackSx2,
  ticketsDetailModalTypographySx1,
  ticketsDetailModalTypographySx2,
  ticketsDetailModalTypographySx3,
  ticketsDetailModalTypographySx4,
  ticketsDetailModalTypographySx5,
  ticketsDetailModalTypographySx6,
} from "../../styles/common";
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        showNotification({
          type: "success",
          message:
            statusMessages[action ?? ""] ?? "Ticket updated successfully.",
        });
  ...
  return (
    <>
      <Dialog
        ...
        maxWidth="lg"
      >
        <DialogTitle component="div" sx={ticketsDetailModalCallbackCallbackSx1}>
          <Stack direction="row" spacing={1.4} alignItems="center">
            <Avatar sx={ticketsDetailModalAvatarSx1}>
              <CheckOutlinedIcon fontSize="small" />
            </Avatar>
            <Box>
              <Typography sx={detailLabelSx}>Ticket details</Typography>
              <Typography sx={ticketsDetailModalTypographySx1}>
                {data.number}
              </Typography>
              <Chip
          ...
          <Stack direction="row" spacing={2.5} alignItems="center">
            ...
            >
              <Avatar sx={ticketsDetailModalAvatarSx2}>
              ...
              <Box>
                ...
                <Typography
                  sx={ticketsDetailModalDynamicDynamicTypographySx1({
                    detailValueSx,
                  })}
                >
          ...
          <Grid container spacing={2}>
            ...
            <Grid size={{ xs: 12, md: 8 }}>
              ...
              >
                ...
                <Paper variant="outlined" sx={ticketsDetailModalPaperSx1}>
                  <Grid container spacing={2}>
                    <Grid size={{ xs: 4 }}>
                      <Box
                        sx={ticketsDetailModalDynamicDynamicBoxSx3({
                          modalPalette,
                        })}
                      >
                        <Box>
            ...
            <Grid size={{ xs: 12, md: 4 }}>
              ...
              >
                ...
                <Box sx={ticketsDetailModalBoxSx1}>
                  {/* Vertical Timeline Line */}
                  <Box
                    sx={ticketsDetailModalDynamicDynamicBoxSx7({
                      modalPalette,
                    })}
                  />
                  ...
                  <Stack spacing={2}>
                    {data.logs?.map((log: TicketLog, index: number) => (
                      <Box key={log.id} sx={ticketsDetailModalBoxSx2}>
                        <Box
                          sx={ticketsDetailModalDynamicDynamicBoxSx8({
                            getStatusColor,
                            log,
                          })}
                        />
                        <Box
                          sx={ticketsDetailModalDynamicDynamicBoxSx9({
                            index,
                            modalPalette,
                          })}
                        >
                          <Chip
                            ...
                            size="small"
                            sx={ticketsDetailModalDynamicDynamicChipSx2({
                              alpha,
                              getStatusColor,
                              isDark,
                              log,
          ...
          {data.files?.length ? (
            <Box sx={attachmentSectionSx(theme)}>
              <Box sx={attachmentHeaderSx}>
                <AttachmentOutlinedIcon color="primary" fontSize="small" />
                <Typography sx={detailLabelSx}>
      ...
      <ConfirmDialog
        ...
        confirmIcon={<PauseCircleOutlineOutlinedIcon />}
        confirmDisabled={!remarks.trim()}
        tone="warning"
      >
        <TextField
      ...
      <ConfirmDialog
        ...
        title="Accept Ticket"
        titleIcon={<CheckCircleOutlinedIcon />}
        description={
        ...
        confirmIcon={<CheckCircleOutlinedIcon />}
        confirmDisabled={requiresEstimatedHours && Number(estimatedHrs) <= 0}
        tone="success"
      >
        {requiresEstimatedHours && (
          <Grid size={{ xs: 12, md: 4 }}>
      ...
      <ConfirmDialog
        ...
        titleIcon={<PendingActionsOutlinedIcon />}
      ...
      <ConfirmDialog
        ...
        titleIcon={<AssignmentTurnedInOutlinedIcon />}
        description="This action will recall and close the ticket. Do you want to continue?"
        confirmLabel="Confirm"
        confirmColor="success"
        confirmIcon={<AssignmentTurnedInOutlinedIcon />}
        tone="success"
      />
    </>
  );
