...
const emptyForm: SelfTicketFormData = {
  task: "",
  description: "",
  current_status: "open",
  est_hours: 0,
...
export default function CreateSelfTicketModel({
  ...
  const [formData, setFormData] = useState<SelfTicketFormData>(emptyForm);
          ...
          <Paper elevation={8} sx={selfTicketsCreateModelPaperSx1}>
            ...
            >
              <Box sx={selfTicketsCreateModelBoxSx1}>
                <InfoOutlinedIcon sx={selfTicketsCreateModelInfoOutlinedSx1} />
              </Box>
              <Typography
                variant="subtitle2"
                fontWeight={900}
      ...
      <DialogActions>
        ...
        >
          <Box sx={selfTicketsCreateModelBoxSx5}>
            <InfoOutlinedIcon sx={selfTicketsCreateModelInfoOutlinedSx2} />
          </Box>
          <Typography
            variant="caption"
