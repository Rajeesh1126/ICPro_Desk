    ...
    def handle(self, *args, **options):
        role_permissions = {
            'Admin': [
                ...
                'view_timesheetweeklog', 'add_timesheetweeklog', 'change_timesheetweeklog', 'delete_timesheetweeklog',
                ...
                'access_timesheet', 'access_all_timesheet_logs',
                'access_executive_overview', 'access_team_analysis',
            ...
            'Manager': [
                ...
                'view_timesheetweeklog', 'add_timesheetweeklog', 'change_timesheetweeklog',
